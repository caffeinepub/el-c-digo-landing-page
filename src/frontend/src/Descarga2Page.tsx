const SITE_HTML = `<!-- =================================================================
     ...
     1. Cole este código no widget HTML do Elementor.

     2. TROCAR VÍDEO — PASSO 1 DE 2:
        Busque "TROCAR VÍDEO — PASSO 1 DE 2" no código.
        Cole a tag <vturb-smartplayer id="vid-SEU-ID"> no lugar marcado.

     3. TROCAR VÍDEO — PASSO 2 DE 2:
        Busque "TROCAR VÍDEO — PASSO 2 DE 2" no final do código.
        Cole o <script> da Vturb no lugar marcado.

     4. LINK DO CHECKOUT: busque "LINK DO CHECKOUT" e edite a URL.
        Link atual: https://pay.hotmart.com/S104758048Y?checkoutMode=10

     5. EDITAR FOOTER: busque "EDITAR FOOTER" e edite o copyright.
================================================================= -->
...
.ec-wrap h1,.ec-wrap h2,.ec-wrap h3,.ec-wrap h4{margin:0}
.ec-wrap p{margin:0}
...
<!-- TROCAR VÍDEO — PASSO 1 DE 2
     Cole a tag <vturb-smartplayer> abaixo dentro do div marcado.
     Exemplo: <vturb-smartplayer id="vid-SEU-ID" style="display:block;margin:0 auto;width:100%"></vturb-smartplayer>
     O script da Vturb vai no PASSO 2 DE 2 no final deste arquivo. -->
<section id="video" style="background:#000;padding:0 1.5rem;text-align:center">
  <div style="max-width:700px;margin:0 auto">
    ...
    <div style="border-radius:12px;border:1px solid #2a2a2a;overflow:hidden;min-height:8px">
      <!-- COLE A TAG <vturb-smartplayer> AQUI (PASSO 1 DE 2) -->
    </div>
  </div>
</section>
...
<section id="solucion" style="background:#000;padding:clamp(48px,6vw,72px) 1.5rem">
  <div style="max-width:820px;margin:0 auto">
    ...
    <div class="ec-grid-4" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.25rem;margin-bottom:3rem">
...
<section id="para-quien" style="background:#111;padding:clamp(48px,6vw,72px) 1.5rem">
  <div style="max-width:860px;margin:0 auto">
    ...
    <div class="ec-grid-2" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:1.5rem">
...
<!-- LINK DO CHECKOUT HOTMART
     Para trocar: edite a URL no href abaixo.
     Link atual: https://pay.hotmart.com/S104758048Y?checkoutMode=10 -->
...
<!-- EDITAR FOOTER — edite o copyright abaixo -->
...
<!-- JAVASCRIPT: accordion FAQ + scroll suave para #precio -->
<script>
...
<!-- TROCAR VÍDEO — PASSO 2 DE 2
     Cole o script da Vturb abaixo (substitua o ID na URL):

     Exemplo:
       var s=document.createElement("script");
       s.src="https://scripts.converteai.net/ACCOUNT/players/SEU-NOVO-ID/v4/player.js";
       s.async=true;
       document.head.appendChild(s);

     ID de exemplo: 69cb28db953ef32c144df9b8 -->

</div>`;

export default function Descarga2Page() {
  return (
    <div
      style={{
        background: "#000",
    ...
    >
      <div style={{ maxWidth: "860px", margin: "0 auto" }}>
        ...
        >
          El Código —{" "}
          <span style={{ color: "#C1121F" }}>HTML para Elementor</span>
        </h1>
        ...
        >
          Clique dentro da caixa abaixo →{" "}
          <strong style={{ color: "#fff" }}>Ctrl+A</strong> para selecionar tudo
          → <strong style={{ color: "#fff" }}>Ctrl+C</strong> para copiar → cole
        ...
        >
          ...
          >
            Use Ctrl+F para encontrar estes pontos no código:
          </p>
        ...
        >
          Clique na caixa → <strong style={{ color: "#888" }}>Ctrl+A</strong> →{" "}
          <strong style={{ color: "#888" }}>Ctrl+C</strong> → cole no Elementor
        </p>
      </div>
    </div>
  );
